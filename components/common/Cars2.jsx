...
export default function Cars2() {
  ...
  const [selectCategory, setSelectCategory] = useState(carCategories[0]);
  const [carData, setCarData] = useState([]);

  useEffect(() => {
    fetch("/assets/cars.json")
      .then((r) => r.json())
      .then((data) => setCarData(data.map((car, i) => transformCar(car, i))))
      .catch(console.error);
  }, []);
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="heading-section flex align-center justify-space flex-wrap gap-20">
              ...
              >
                Used Cars To Suit Your Lifestyle
              </h2>
              <Link
                href={`/listing-list`}
            ...
            <div className="flat-tabs themesflat-tabs">
              ...
              <div className="content-tab">
                <div className="content-inner tab-content">
                  ...
                  <div className="swiper-button-next style-2 snbn4" />
                  <div className="swiper-button-prev style-2 snbp4" />
                </div>
              </div>
            </div>
          </div>
