...
const priceRanges = [
  { title: "Blue Dot Autos used cars", isActive: true, range: null },
  {
    title: "$50.000 - $70.000",
    isActive: false,
...
export default function Cars3() {
  ...
  useEffect(() => {
    fetch("/assets/cars.json")
      .then((r) => r.json())
      .then((data) => {
        const transformed = data.map((car, i) => transformCar(car, i));
        setCarData(transformed);
            ...
            <div className="flat-tabs themesflat-tabs">
              ...
              <div className="content-tab">
                <div className="content-inner tab-content">
                  ...
                  <div className="swiper-button-next style-2 snbn5" />
                  <div className="swiper-button-prev style-2 snbp5" />
                </div>
              </div>
            </div>
          </div>
